...
{
	name = "Fix Hint Color Messages + Remove $ Dollar",
	description = "Fix for PrintHintText and PrintCenterText colors msgs in csgo + Remove $ Dollar",
	author = "Phoenix (˙·٠●Феникс●٠·˙), Gold KingZ",
	version = "1.0.0",
